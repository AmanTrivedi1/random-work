          ...
          {active === item && (
            <div className="absolute top-[calc(100%_+_1.2rem)] left-1/2 transform -translate-x-1/2 pt-4">
              <motion.div
                ...
                <motion.div
                  layout 
                  className="min-w-[100vh] h-full p-4">
                  {children}
                </motion.div>
              </motion.div>
            </div>
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full boder border-transparent  bg-white shadow-input flex justify-center space-x-4 px-8 py-6 ">
      {children}
    </nav>
  );
};
